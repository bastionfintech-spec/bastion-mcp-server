...
```bash
git clone https://github.com/bastionfintech-spec/BASTIONFI.git
cd BASTIONFI
```
...
- Join the community on [GitHub Discussions](https://github.com/bastionfintech-spec/BASTIONFI/discussions)
